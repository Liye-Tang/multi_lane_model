...
def plot_opt_results_of_all_alg_n_runs(dirs_dict_for_plot=None):
    ...
    alg_list = ['ampc']
    data2plot_dir = WORKING_DIR + '/results/{}/data2plot/good'
    df_list = []
    for alg in alg_list:
