...
class IdcVirtualModel(object):  # all tensors
    ...
    def compute_rewards(self, obses, actions, untransformed_action):
        ...
        with tf.name_scope('compute_reward') as scope:
            ...
            scale = dict(rew_devi_v=-0.25, rew_devi_lateral=-0.8, rew_devi_phi=-30., rew_yaw_rate=-0.02, rew_vy=-0.01,
                         ...
                         rew_yaw_rate_4value=-0.02, rew_vy_4value=-0.01, rew_steer0_4value=-1., rew_a_x0_4value=-0.01,
