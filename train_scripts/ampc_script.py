...
def built_AMPC_parser():
    ...
    # optimizer (PABAL)
    parser.add_argument('--num_workers', type=int, default=1 if mode == 'debug' else 3)
    parser.add_argument('--num_learners', type=int, default=2 if mode == 'debug' else 10)
    parser.add_argument('--num_buffers', type=int, default=1 if mode == 'debug' else 3)
